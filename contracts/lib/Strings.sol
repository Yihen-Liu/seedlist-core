...
library Strings {
     ...
     */
    function _equals(slice memory self, slice memory other) internal pure returns (bool) {
        return compare(self, other) == 0;
    }
    function equals(string memory self, string memory other) internal pure returns (bool) {
        return _equals(toSlice(self), toSlice(other));
    }
     ...
     */
    function _concat(slice memory self, slice memory other) internal pure returns (string memory) {
    ...
    function concat(string memory self, string memory other) internal pure returns(string memory){
        return _concat(toSlice(self), toSlice(other));
    }
    /*
...
///////////////////////////////////////////
    ...
    function addressToAsciiString(address _address) public pure returns (string memory) {
        ...
        for (uint i = 0; i < 20; i++) {
            bytes1 b = bytes1(uint8(uint160(_address) / (2 ** (8 * (19 - i)))));
    ...
    function fromAddress(address _address) public pure returns (string memory) {
        return _concat(toSlice("0x"), toSlice(addressToAsciiString(_address)));
    }
}
