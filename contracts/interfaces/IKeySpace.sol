...
interface IKeySpace {
    ...
    function addKey(address keyspace, address addr, address addr0, bytes32 addrHash, bytes32 r, bytes32 s, uint8 v, address id, string memory cryptoKey, string memory labelName, address receiver) external returns(bool);
